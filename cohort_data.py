...
def unique_houses(filename):
    ...
    for line in the_file:
        ...
        if list_cohort_data[2] is not '':
            houses.add(list_cohort_data[2])
...
def sort_by_cohort(filename):
    ...
    for line in the_file:
        ...
        line = line.rstrip()
        list_cohort_data = line.split("|")
        # if list_cohort_data[4] != "I":
        if list_cohort_data[4] == "Spring 2016":
            name = list_cohort_data[0] + " " + list_cohort_data[1]
            spring_16.append(name)
        elif list_cohort_data[4] == "Winter 2016":
            name = list_cohort_data[0] + " " + list_cohort_data[1]
            winter_16.append(name)
        elif list_cohort_data[4] == "Summer 2016":
            name = list_cohort_data[0] + " " + list_cohort_data[1]
            summer_16.append(name)
        elif list_cohort_data[4] == "Fall 2015":
            name = list_cohort_data[0] + " " + list_cohort_data[1]
            fall_15.append(name)
        elif list_cohort_data[4] == "G":
            name = list_cohort_data[0] + " " + list_cohort_data[1]
            ghosts.append(name)
...
def hogwarts_by_house(filename):
    ...
    for line in the_file:
        ...
        line = line.rstrip()
        list_cohort_data = line.split("|")
        if list_cohort_data[2] == "Dumbledore's Army":
            dumbledores_army.append(list_cohort_data[1])
        elif list_cohort_data[2] == "Gryffindor":
            gryffindor.append(list_cohort_data[1])
        elif list_cohort_data[2] == "Slytherin":
            slytherin.append(list_cohort_data[1])
        elif list_cohort_data[2] == "Ravenclaw":
            ravenclaw.append(list_cohort_data[1])
        elif list_cohort_data[2] == "Hufflepuff":
            hufflepuff.append(list_cohort_data[1])
        elif list_cohort_data[4] == "G":
            ghosts.append(list_cohort_data[1])
        elif list_cohort_data[4] == "I":
            instructors.append(list_cohort_data[1])
